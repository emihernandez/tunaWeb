(function(angular) {
    ...
    angular.module('FileManagerApp').service('fileNavigator', [
        ...
        var FileNavigator = function(auditoriaId, medida) {
        ...
        FileNavigator.prototype.list = function() {
            ...
            if(!fileManagerConfig.uploadFile){
              data.path = '/Comprobantes'; 
            }
            $http.post(fileManagerConfig.listUrl + '?id=' + this.auditoriaId, data).success(function(data) {
        ...
        FileNavigator.prototype.refresh = function() {
            ...
            return self.list().then(function(data) {
                self.fileList = (data.result || []).map(function(file) {
                    return new Item(file, self.currentPath, self.auditoriaId);
                })
                self.buildTree(path);
            });
        };
